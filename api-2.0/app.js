...
const corp_routes = require('./routes/corporate_routes');
...
app.use("/app/org/", org_routes);
app.use("/app/corp", corp_routes);
app.use("/app/citizen", user_routes);
// set secret variable
app.set('secret', 'thisismysecret');
app.use(expressJWT({
    secret: 'thisismysecret'
}).unless({
    path: ['/users','/users/login', '/register', '/app/*']
}));
app.use(bearerToken());
