...
const { update_corporate, update_corporate_pic, change_corporate_password, corp_identity_shares_history, 
    corp_identity_share, create_identity_share, get_all_corporatess, corp_register_controler, login_controler, 
    logout_controler, refresh_token_controler, verfy_otp, corp_verify_email, get_corp_info,
     get_corporate_notification, corporate_stats } = require("../controllers/corporate_controller");
...
router.post('/update/:corp_id/pic', update_corporate_pic);
...
router.get('/corporate_stats', corporate_stats);
